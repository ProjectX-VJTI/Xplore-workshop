...
def unique_intersection(a: Iterable, b: Iterable) -> Set:
    ...
    print(type(a)) #initially type of the argument is list
...
#basically Mr. X at projectX wants us to return a set but with elements that are either found in set a or set b but not both 
