...
array = list(map(int, input("Enter an array of numbers: ").split())) # took help of claude for this line

print(type(array)) # should output 'list'

nums = [1,2,3,4]
print(nums[0], nums[1],nums[2],nums[3], sep=",")  # print it as a string joined by commas : 1,2,3,4
...
print(f"{x}\n{y}\n{z}") #As we are adding int with string we need to use f string, it took some mins for me to figure out :(
